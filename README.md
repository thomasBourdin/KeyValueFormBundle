...
```bash
$ composer require thomasBourdin/key-value-form-bundle:@stable
```
...
public function registerBundles()
{
    $bundles = array(
        // ...
        new thomasBourdin\Bundle\KeyValueFormBundle\BurgovKeyValueFormBundle(),
        // ...
    );
}
```
...
```twig
{% block partitech_key_value_widget %}
