...
use thomasBourdin\Bundle\KeyValueFormBundle\Form\DataTransformer\HashToKeyValueArrayTransformer;
...
class KeyValueType extends AbstractType
{
    ...
    public function configureOptions(OptionsResolver $resolver)
    {
        ...
        $resolver->setDefaults(array(
            $isSf28 ? 'entry_type' : 'type' => $isSf28 ? __NAMESPACE__.'\KeyValueRowType' : 'partitech_key_value_row',
            'allow_add' => true,
            'allow_delete' => true,
