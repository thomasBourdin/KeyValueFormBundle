...
namespace thomasBourdin\Bundle\KeyValueFormBundle\Tests\Form\Type;

use thomasBourdin\Bundle\KeyValueFormBundle\Form\Type\KeyValueRowType;
use thomasBourdin\Bundle\KeyValueFormBundle\Form\Type\KeyValueType;
        ...
        if (null === self::$isSf28) {
            ...
            if (self::$isSf28) {
                self::$typeNames = array(
                    ...
                    'partitech_key_value' => 'thomasBourdin\Bundle\KeyValueFormBundle\Form\Type\KeyValueType',
                );
            } else {
                self::$typeNames = array(
                    'choice' => 'choice',
